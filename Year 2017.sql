DROP DATABASE IF EXISTS `year_2017`;
CREATE DATABASE `year_2017`; 
USE year_2017;

CREATE TABLE `2017_sa_casualty`  (
...
LOAD DATA INFILE 'C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/road-crash-data-2017/2017_DATA_SA_Casualty.csv' 
INTO TABLE `2017_sa_casualty`
...
LOAD DATA INFILE 'C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/road-crash-data-2017/2017_DATA_SA_Crash.csv' 
INTO TABLE `2017_sa_crash`
FIELDS TERMINATED BY ','
OPTIONALLY ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
IGNORE 1 ROWS
...
LOAD DATA INFILE 'C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/road-crash-data-2017/2017_DATA_SA_Units.csv' 
INTO TABLE `2017_sa_units`
FIELDS TERMINATED BY ','
OPTIONALLY ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
IGNORE 1 ROWS
