DROP DATABASE IF EXISTS `year_2016`;
CREATE DATABASE `year_2016`; 
USE year_2016;

CREATE TABLE `2016_sa_casualty`  (
...
LOAD DATA INFILE 'C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/road-crash-data-2016/2016_DATA_SA_Casualty.csv' 
INTO TABLE `2016_sa_casualty`
...
LOAD DATA INFILE 'C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/road-crash-data-2016/2016_DATA_SA_Crash.csv' 
INTO TABLE `2016_sa_crash`
FIELDS TERMINATED BY ','
OPTIONALLY ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
IGNORE 1 ROWS
...
LOAD DATA INFILE 'C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/road-crash-data-2016/2016_DATA_SA_Units.csv' 
INTO TABLE `2016_sa_units`
FIELDS TERMINATED BY ','
OPTIONALLY ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
IGNORE 1 ROWS
